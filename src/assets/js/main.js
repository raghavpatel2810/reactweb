...
(function ($) {
	...
	$('[data-countdown]').each(function () {
		...
		$this.countdown(finalDate, function (event) {
			$this.html(event.strftime('<span className="ht-count days"><span className="count-inner"><span className="time-count">%-D</span> <span>Days</span></span></span> <span className="ht-count hour"><span className="count-inner"><span className="time-count">%-H</span> <span>HR</span></span></span> <span className="ht-count minutes"><span className="count-inner"><span className="time-count">%M</span> <span>Min</span></span></span> <span className="ht-count second"><span className="count-inner"><span className="time-count">%S</span> <span>Sc</span></span></span>'));
		});
	});
	...
	function load_more(){
        ...
        $(".loadMore").on('click', function (e) {
            ...
            if ($(".product-load-more .item:hidden").length == 0) {
                $(".infinitpagin").html('<div className="btn loadMore">no more products</div>');
            }
        });
    }
	load_more();
	...
	function load_more_post(){
        ...
        $(".loadMorepost").on('click', function (e) {
            ...
            if ($(".blog--grid-load-more .article:hidden").length == 0) {
                $(".loadmore-post").html('<div className="btn loadMorepost">No more Blog Post</div>');
            }
        });
    }
	load_more_post();
